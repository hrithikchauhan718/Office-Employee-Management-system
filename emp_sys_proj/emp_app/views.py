...
def add_emp(request):
    if request.method == 'POST':
        ...
        # Check for empty values before converting to integers
        if not all([first_name, salary, bonus, phone, dept_id, role_id]):
        ...
        try:
            ...
            return HttpResponse('Invalid input for salary, bonus, phone, department, or role.')
